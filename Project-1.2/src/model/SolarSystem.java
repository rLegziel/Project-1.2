...
import static model.Body.CelestialBody.*;

public class SolarSystem extends BodySystem {
    private static Body.CelestialBody[] CELESTIAL_BODIES_IN_SYSTEM = new Body.CelestialBody[]{SUN, MERCURY, VENUS, EARTH, MARS, JUPITER, SATURN, NEPTUNE, URANUS, PLUTO};
